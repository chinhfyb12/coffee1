                ...
                <nav className="navbar d-flex align-items-start justify-content-start">
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <NavLink  onClick={ handleClickMenu } to="/ca-phe-trung-nguyen-cao-cap" className="nav-link">Cà phê Trung Nguyên cao cấp</NavLink>
                        </li>
                        <li className="nav-item">
                            <div className="box_link d-flex">
                                <NavLink onClick={ handleClickMenu } to="/ca-phe-rang-xay" className="nav-link d-flex">Cà phê rang xay</NavLink>
                            ...
                            <nav className="navbar__2 collapse" id="nav_2">
                                <ul className="navbar-nav navbar-nav__2">
                                    <li className="nav-item nav-item__2">
                                        <NavLink onClick={ handleClickMenu } to="/ca-phe-rang-xay/ca-phe-vien-nen-trung-nguyen" className="nav-link">Cà phê viên nén Trung Nguyên</NavLink>
                                    </li>
                                    <li className="nav-item nav-item__2">
                                        <NavLink onClick={ handleClickMenu } to="/ca-phe-rang-xay/rang-xay-pho-thong" className="nav-link">Rang xay phổ thông</NavLink>
                                    </li>
                                </ul>
                            </nav>
                        </li>
                        <li className="nav-item">
                            <NavLink onClick={ handleClickMenu } to="/ca-phe-con-soc" className="nav-link">Cà phê con sóc</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink onClick={ handleClickMenu } to="/ca-phe-hoa-tan" className="nav-link">Cà phê hòa tan</NavLink>
                        </li>
                    </ul>
                </nav>
            </div>
